...
const GULF_MARKETS = {
  'Saudi Arabia': {
    flag: '🇸🇦', exchange: 'Tadawul', index: 'TASI',
    indexValue: '11,842', indexChange: 0.54,
    currency: 'SAR', color: '#22c55e',
  ...
  'UAE': {
    flag: '🇦🇪', exchange: 'DFM / ADX', index: 'DFMGI',
    indexValue: '4,284', indexChange: 1.34,
    currency: 'AED', color: '#0ed2c8',
  ...
  'Qatar': {
    flag: '🇶🇦', exchange: 'QSE', index: 'QE Index',
    indexValue: '9,842', indexChange: -0.18,
    currency: 'QAR', color: '#8b5cf6',
  ...
  'Kuwait': {
    flag: '🇰🇼', exchange: 'Boursa Kuwait', index: 'BKP',
    indexValue: '7,124', indexChange: 0.22,
    currency: 'KWD', color: '#f0b429',
  ...
  return (
    <div style={{ width: '100%', animation: 'fadeInUp 0.4s ease' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8, marginBottom: 12 }}>
        {Object.entries(GULF_MARKETS).map(function(entry) {
          var name = entry[0];
          var m = entry[1];
          var isActive = activeMarket === name;
          var isUp = m.indexChange >= 0;
          return (
            <div
              key={name}
              onClick={function() { setActiveMarket(name); }}
              style={{
                background: isActive
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
            <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 13 }}>
              ...
              style={{
                ...
                fontSize: 10, color: market.color, textDecoration: 'none',
              }}
            >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <div className="card" style={{
            ...
            {[
              ...
              { label: 'Stocks Shown', value: market.stocks.length },
          ...
          <div style={{
            ...
            <p style={{ fontSize: 10, color: 'var(--text-secondary)', lineHeight: 1.7 }}>
              ...
              The GCC has the highest concentration of AAOIFI-certified institutions in the world.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 11, fontWeight: 600, color: 'var(--accent-gold)', marginBottom: 6 }}>
              📊 Live Exchange Links
            </div>
